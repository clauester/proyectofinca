...
public class Finca extends javax.swing.JPanel {
    ...
    public void llenarTabla() {
        try {
            ResultSet data = getdata.GetFincas();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FincasSubView fincaView = new FincasSubView("agregar");

        fincaView.setVisible(true);
...
//        int selectedColumn = tbl_propietarios.getSelectedColumn
        if (selectedRow >= 0) {
            ...
            FincasSubView fincaView = new FincasSubView("actualizar", valueId);
            fincaView.setVisible(true);
